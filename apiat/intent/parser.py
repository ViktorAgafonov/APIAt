...
SYSTEM_PROMPT = (
    ...
    "Для YouTube задач: если упоминается название канала (не точный URL) — заполни channel_search именем канала, url оставь пустым. "
    "Если просят обложку, превью или thumbnail — установи thumbnail=true. "
    "Если просят субтитры — subtitles=true. "
    "Если просят только информацию/метаданные о видео без скачивания — metadata_only=true."
)
